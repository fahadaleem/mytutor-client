...
const CourseDetails = () => {
  ...
  const { handleGetCourseDetails, courseDetails, loading } = useContext(CourseContext);
  ...
  return (
    <div>
    {loading? <SimpleBackdrop />:<Container maxWidth="lg">
    <CourseDetailsHeader
    ...
    <CourseTeacherDetails courseTeacherName={courseDetails.teacher_name} courseTeacherExperience = {courseDetails.teacher_teaching_experience} courseTeacherIntro = {courseDetails.teacher_intro} />
    <Reviews />
  </Container> }
  </div>
